...
class LiveControlTests(unittest.TestCase):
    ...
    def test_reverse_is_limited_to_thirty_percent_and_release_is_immediately_neutral(self) -> None:
        ...
        self.assertEqual(reverse.throttle_us, 1425)
        self.assertEqual(neutral.throttle_us, 1500)
        self.assertEqual(reverse_again.throttle_us, 1425)
    ...
    def test_reverse_limit_uses_the_calibrated_reverse_span(self) -> None:
        ...
        self.assertEqual(reverse.throttle_us, 1410)
